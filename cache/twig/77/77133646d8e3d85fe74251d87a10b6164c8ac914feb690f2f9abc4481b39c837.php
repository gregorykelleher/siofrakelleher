...
class __TwigTemplate_35cd8fa077ec2211963ba717a9a1a94476ddb9eaa4085cf8cb7e0260e9678048 extends Twig_Template
{
    ...
    <div class=\"social-icons\">
        ...
        // line 24
        echo "        ";
        if ($this->getAttribute($this->getAttribute(($context["site"] ?? null), "owner", array()), "instagram", array())) {
            // line 25
            echo "        <a href=\"http://instagram.com/";
            echo $this->getAttribute($this->getAttribute(($context["site"] ?? null), "owner", array()), "instagram", array());
            echo "\">
            <span class=\"fa-stack fa-lg\">
                <i class=\"fa fa-circle fa-stack-2x fa-inverse\"></i>
        ...
        // line 32
        echo "        ";
        if ($this->getAttribute($this->getAttribute(($context["site"] ?? null), "owner", array()), "github", array())) {
            // line 33
            echo "        <a href=\"http://github.com/";
            echo $this->getAttribute($this->getAttribute(($context["site"] ?? null), "owner", array()), "github", array());
            echo "\">
            <span class=\"fa-stack fa-lg\">
                <i class=\"fa fa-circle fa-stack-2x fa-inverse\"></i>
    ...
    <div class=\"copyright\">
         <section><a href=\"{{ site.url }}\">&copy; {{ site.owner.name }}</a></section>
         <section>Proudly published with <a class=\"icon-ghost\" href=\"https://jekyllrb.com/\">Grav</a></section>
    </div>
    <div class=\"social-icons\">
    ...
    <div class=\"cf\"></div>
</footer>", "partials/footer.html.twig", "/Users/gregory/Documents/sites/siofrakelleher.com/user/themes/notepad/templates/partials/footer.html.twig");
    }
}
